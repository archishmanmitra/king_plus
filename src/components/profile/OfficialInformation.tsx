...
import { Edit, Building, Calendar, User, Download, Upload, FileText, CheckCircle, Clock, Star, Trash2 } from 'lucide-react';
          ...
          <Card className="border-2 border-primary/20 bg-primary/5">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Core employment and role information</CardDescription>
              </div>
                ...
                {isEditMode ? (
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        id="baseLocation" 
                        defaultValue={data.baseLocation} 
                        disabled={!canEdit}
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-muted-foreground">Known As</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-muted-foreground">Job Confirmation</label>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-foreground font-medium">{data.designation}</p>
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-muted-foreground">Sub Stream</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-muted-foreground">Unit Head</label>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Job confirmation status and details (if confirmed)</CardDescription>
              </div>
              ...
              {isEditMode ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select value={data.confirmationDetails?.status || "pending"} disabled={!canEdit}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      id="confirmationDate" 
                      type="date" 
                      defaultValue={data.confirmationDetails?.confirmationDate || ""} 
                      disabled={!canEdit}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      defaultValue={data.confirmationDetails?.approval || ""} 
                      disabled={!canEdit}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      max="5" 
                      step="0.1"
                      defaultValue={data.confirmationDetails?.rating || 3} 
                      disabled={!canEdit}
                ...
                data.jobConfirmation && data.confirmationDetails ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-foreground flex items-center">
                        <Calendar className="h-4 w-4 mr-2" />
                        {new Date(data.confirmationDetails.confirmationDate).toLocaleDateString()}
                      </p>
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-muted-foreground">Approval</label>
                      <p className="text-foreground">{data.confirmationDetails.approval}</p>
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-muted-foreground">Rating</label>
                      <div className="flex items-center">
                        <Star className="h-4 w-4 mr-1 text-yellow-500 fill-current" />
                        <p className="text-foreground">{data.confirmationDetails.rating}/5</p>
                      </div>
                    </div>
                  </div>
                ) : (
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground">Job confirmation pending</p>
                    <p className="text-sm text-muted-foreground">Confirmation details will appear here once confirmed</p>
                  </div>
                )
              )}
            </CardContent>
            ...
            <CardContent className="space-y-4">
                          ...
                          {isEditMode ? (
                            <div className="space-y-2">
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                <div>
                                  <Label htmlFor={`doc-name-${index}`} className="text-xs">Document Name</Label>
                                  <Input 
                                    id={`doc-name-${index}`}
                                ...
                                <div>
                                  <Label htmlFor={`doc-type-${index}`} className="text-xs">Document Type</Label>
                                  <Select value={doc.type} disabled={!canEdit}>
                                    ...
                                    <SelectContent>
                                      ...
                                      <SelectItem value="Confirmation Letter">Confirmation Letter</SelectItem>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                <div>
                                  <Label htmlFor={`doc-upload-date-${index}`} className="text-xs">Upload Date</Label>
                                  <Input 
                                ...
                                <div>
                                  <Label htmlFor={`doc-file-${index}`} className="text-xs">Upload File</Label>
                                  <Input 
                                    id={`doc-file-${index}`}
                                    type="file"
                                    disabled={!canEdit}
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                Uploaded by: {doc.uploadedBy === 'hr' ? 'HR/Admin' : doc.uploadedBy}
                              </p>
                            </div>
                          )}
                        </div>
              ...
              <div className="bg-muted/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>• Document names should not contain special characters</li>
